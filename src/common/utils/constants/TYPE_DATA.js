export const TYPE_DATA = {
    ...
    electric: {
      background: 'linear-gradient(90deg, hsla(58, 77%, 50%, 1) 0%, hsla(281, 95%, 52%, 1) 100%)',
    ...
    ground: {
      background: 'linear-gradient(90deg, hsla(54, 50%, 28%, 1) 0%, hsla(48, 22%, 78%, 1) 100%)',
    ...
    bug: {
      background: 'linear-gradient(90deg, hsla(15, 21%, 65%, 1) 0%, hsla(4, 17%, 48%, 1) 100%)',
    ...
    dragon: {
      background: 'linear-gradient(90deg, hsla(105, 89%, 29%, 1) 0%, hsla(57, 90%, 51%, 1) 50%, hsla(6, 95%, 50%, 1) 100%)',
    ...
    default: {
      ...
      icon: 'https://raw.githubusercontent.com/duiker101/pokemon-type-svg-icons/master/icons/default.svg'
    }
};
